...
class Session
{
    ...
    */
   function register($subuser, $subpass, $subemail, $subnamalengkap, $subphonenumber){
      ...
      /* No errors, add the new account to the */
        ...
        $subalamatlengkap = "";
         if($database->addNewUser($subuser, md5($subpass), $subemail, $subnamalengkap, $subphonenumber, $subalamatlengkap)){
            if(EMAIL_WELCOME){
