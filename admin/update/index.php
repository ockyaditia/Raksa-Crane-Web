...
<head>
  ...
  <meta name="description" content="Geek Web Service">
  <meta name="author" content="">

  <title>Update Geek Web Service CMS | RWK</title>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="../resource/assets/css/pages/maintenance.css">
...
<body class="page-maintenance layout-full">
  ...
  data-animsition-out="fade-out">>
    <div class="page-content vertical-align-middle">
      ...
      <h2>Tell us if you want to update this CMS</h2>
      <p>admin@geekwebservice.uk</p>

      <footer class="page-copyright">
        <p>WEBSITE BY Geek Web Service</p>
        <p>© 2015. All RIGHT RESERVED.</p>
        <div class="social">
          <a href="http://www.twitter.com/geekwebservice">
            <i class="icon bd-twitter" aria-hidden="true"></i>
          </a>
          <a href="http://www.facebook.com/geekwebservice">
            <i class="icon bd-facebook" aria-hidden="true"></i>
          </a>
          <a href="http://id.linkedin.com/in/admins">
