...
<body>
  ...
  <div class="page animsition">
    ...
    <div class="page-content container-fluid">
      ...
      <h1 class="page-title">Tambah Post</h1>
      <ol class="breadcrumb">
     ...
     <div class="panel">
            ...
            <div class="panel-body container-fluid">
               <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="blog_judul">
               ...
               <div class="example example-responsive">
			    <label class="floating-label">Deskripsi Post</label>
                  <textarea name="blog_content" data-provide="markdown" data-iconlibrary="fa" data-width="600"></textarea>
	  ...
	  while ($cats_row=mysql_fetch_array($run_cats)){
          ...
          <div class="panel">
			...
			<input type="hidden" type="text" name="blog_author" value="<?php echo $session->username ?>">
            <div class="panel-body container-fluid">
                <div align="center" class="form-group form-material floating">
                  <button type="submit" name="submit" id="submit" class="btn btn-animate btn-lg btn-animate-vertical btn-success">
                    <span><i class="icon wb-download" aria-hidden="true"></i>Tambahkan Post</span>
                  </button>
...
if(isset($_POST['submit'])){
	...
	if($blog_judul=='' OR $blog_cat=='null' OR $blog_gambar=='' OR $blog_content==''){
		...
		$insert_product = "insert into blog (blog_judul,blog_date,category_id,blog_author,blog_keywords,blog_gambar,blog_content,blog_published,time) 
		values 
		('$blog_judul','$blog_date','$blog_cat','$blog_author','$blog_keywords','$blog_gambar','$blog_content','$blog_published','$time')";
