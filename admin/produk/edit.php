...
if(isset($_GET['produk_id'])){
	...
	while ($row_products = mysql_fetch_array($run_product))
	{
	 ...
	 $produk_keywords = $row_products['produk_keywords'];
	 $produk_content = $row_products['produk_content'];
...
<head>
  ...
  <title>Edit <?php echo $produk_judul; ?> | RWK</title>
...
<body>
            ...
            <li class="site-menu-item has-sub active open">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item active">
                  <a class="animsition-link" href="index.php" data-slug="produk-semua">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Semua Produk</span>
                  </a>
                </li>
				 <li class="site-menu-item">
                  <a class="animsition-link" href="tambah.php" data-slug="produk-tambah">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Tambah Produk</span>
                  </a>
                </li>
				 <li class="site-menu-item">
                  <a class="animsition-link" href="kategori.php" data-slug="produk-kategori">
                    <i class="site-menu-icon " aria-hidden="true"></i>
  ...
  <div class="page animsition">
    ...
    <div class="page-content container-fluid">
      ...
      <h1 class="page-title">Edit Produk - <?php echo $produk_judul; ?></h1>
      <ol class="breadcrumb">
	...
	<div class="col-sm-8">
     <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title" >Format Produk</h3>
            </div>
            <div class="panel-body container-fluid">
               <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_judul" value='<?php echo $produk_judul; ?>'>
                  <label class="floating-label">Judul Produk</label>
                </div>
               <div class="example example-responsive">
			    <label class="floating-label">Deskripsi Produk</label>
                  <textarea name="produk_content" data-provide="markdown" data-iconlibrary="fa" data-width="600"><?php echo $produk_content; ?></textarea>
				  
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_keywords" value='<?php echo $produk_keywords; ?>'>
                  <label class="floating-label">Kata Kunci Produk</label>
                </div>
		 ...
		 <div class="col-sm-4">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Konfigurasi Produk</h3>
            </div>
            <div class="panel-body container-fluid">
                <div class="form-group form-material floating">
		  ...
		  ";
                ...
                <div class="form-group form-material floating">
                  <select name="produk_tipe" class="form-control">
                    <option>&nbsp;</option>
                    <option value="Dijual" <?php if($produk_tipe=="Dijual"){echo "selected";}?> >Dijual</option>
                    <option value="Disewakan" <?php if($produk_tipe=="Disewakan"){echo "selected";}?> >Disewakan</option>
                  </select>
                  <label class="floating-label">Jenis Produk</label>
                </div>
                  ...
                  <div class="input-group input-group-file">
                    ...
                    <span class="input-group-btn">
                      <span class="btn btn-success btn-file">
                        ...
                        <input name="produk_gambar" type="file" accept="image/*">
                      </span>
                    </span>
                  </div>
                </div>
				<h4 class="example-title">Upload File (PDF/DOC)</h4>
				<div class="form-group">
                  <div class="input-group input-group-file">
                    <input type="text" class="form-control" readonly="">
                    <span class="input-group-btn">
                      <span class="btn btn-outline btn-file">
                        <i class="icon wb-upload" aria-hidden="true"></i>
                        <input name="produk_attachment" type="file" >
                      </span>
                    </span>
                  </div>
                </div>
     ...
     <div class="panel">
            ...
            <div class="panel-body container-fluid">
                <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_pabrikan" value='<?php echo $produk_pabrikan; ?>'/>
                  <label class="floating-label">Pabrikan</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_model" value='<?php echo $produk_model; ?>'/>
                  <label class="floating-label">Model</label>
                </div>
				
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_tahun" value='<?php echo $produk_tahun; ?>' />
                  <label class="floating-label">Tahun</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_harga" value='<?php echo $produk_harga; ?>'/>
                  <label class="floating-label">Harga</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_kapasitas" value='<?php echo $produk_kapasitas; ?>'/>
                  <label class="floating-label">Kapasitas</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_boom" value='<?php echo $produk_boom; ?>'/>
                  <label class="floating-label">Boom</label>
                </div>
               <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_jib" value='<?php echo $produk_jib; ?>'/>
                  <label class="floating-label">Jib</label>
                </div>
                <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_jmlBarang" value='<?php echo $jumlah_barang; ?>'/>
            ...
            <div class="panel-body container-fluid">
                <div align="center" class="form-group form-material floating">
                  <button type="submit" name="submit" id="submit" class="btn btn-animate btn-lg btn-animate-vertical btn-success">
                    <span><i class="icon wb-download" aria-hidden="true"></i>Perbarui Produk</span>
                  </button>
...
if(isset($_POST['submit'])){
	 ...
	 $produk_date = date('d-m-Y');
	 $produk_cat = $_POST['category_id'];
	 $produk_keywords = $_POST['produk_keywords'];
	 $produk_gambar = $_FILES['produk_gambar']['name'];
	 $produk_gambar_tmp = $_FILES['produk_gambar']['tmp_name'];
	 $produk_attachment = $_FILES['produk_attachment']['name'];
	 $produk_attachment_tmp = $_FILES['produk_attachment']['tmp_name'];
	 $produk_content = $_POST['produk_content'];
	 $produk_harga = $_POST['produk_harga'];
	 $produk_pabrikan = $_POST['produk_pabrikan'];
	 $produk_model = $_POST['produk_model'];
	 $produk_tahun = $_POST['produk_tahun'];
	 $produk_kapasitas = $_POST['produk_kapasitas'];
	 $produk_boom = $_POST['produk_boom'];
	 $produk_jib = $_POST['produk_jib'];
	 $jumlah_barang = $_POST['produk_jmlBarang'];
	 $produk_published = 1;
	 
	$allowed =  array('gif','png' ,'jpg');
	$filename = $_FILES['produk_gambar']['name'];
	...
	if($produk_judul=='' OR $produk_cat=='null' OR $produk_gambar=='' OR $produk_content==''){
		...
		mkdir($path);
		$path2 = "<?php echo ROOT_URL; ?>/<?php echo ROOT_URL; ?>/upload/attachment/$time";
		mkdir($path2);
		move_uploaded_file($produk_gambar_tmp,"<?php echo ROOT_URL; ?>/<?php echo ROOT_URL; ?>/upload/images/$time/$produk_gambar");
		move_uploaded_file($produk_attachment_tmp,"<?php echo ROOT_URL; ?>/<?php echo ROOT_URL; ?>/upload/attachment/$time/$produk_attachment");
		
		$update_product = "update produk set produk_judul='$produk_judul',produk_tipe='$produk_tipe',produk_date='$produk_date',category_id='$produk_cat',produk_keywords='$produk_keywords',produk_gambar='$produk_gambar',produk_attachment='$produk_attachment',produk_content='$produk_content',produk_harga='$produk_harga',produk_pabrikan='$produk_pabrikan',produk_model='$produk_model',produk_tahun='$produk_tahun',produk_kapasitas='$produk_kapasitas',produk_boom='$produk_boom',produk_jib='$produk_jib',produk_published='$produk_published',time='$time',jumlah_barang='$jumlah_barang' where produk_id='$produk_id'";
...
$cat_id = $_GET['non_aktifkan'];
	$update_status = "update produk set produk_published='2' where produk_id='$cat_id'";
		
		$run_update = mysql_query($update_status); 
			echo "<script>alert('Produk berhasil di non-aktifkan!')</script>";
			echo "<script>window.open('index.php','_self')</script>";
}

if(isset($_GET['aktifkan'])){
$cat_id = $_GET['aktifkan'];
	$update_status = "update produk set produk_published='1' where produk_id='$cat_id'";
		
		$run_update = mysql_query($update_status); 
			echo "<script>alert('Produk berhasil di aktifkan!')</script>";
			echo "<script>window.open('index.php','_self')</script>";
}
}
else
