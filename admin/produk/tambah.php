  ...
  <div class="page animsition">
	...
	<div class="col-sm-8">
     <div class="panel">
            ...
            <div class="panel-body container-fluid">
               <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_judul">
               ...
               <div class="example example-responsive">
			    <label class="floating-label">Deskripsi Produk</label>
                  <textarea name="produk_content" data-provide="markdown" data-iconlibrary="fa" data-width="600" maxlength="200"></textarea>
				  
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_keywords">
     ...
     <div class="panel">
            ...
            <div class="panel-body container-fluid">
                <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_pabrikan" />
                  <label class="floating-label">Pabrikan</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_model" />
                  <label class="floating-label">Model</label>
                </div>
				
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_tahun" />
				...
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_kapasitas" />
                  <label class="floating-label">Kapasitas</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_boom" />
                  <label class="floating-label">Boom</label>
                </div>
               <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_jib" />
                  <label class="floating-label">Jib</label>
                </div>
				<div class="form-group form-material floating">
                  <input type="text" class="form-control" name="produk_jmlBarang" />
            ...
            <div class="panel-body container-fluid">
                <div align="center" class="form-group form-material floating">
                  <button type="submit" name="submit" id="submit" class="btn btn-animate btn-lg btn-animate-vertical btn-success">
                    <span><i class="icon wb-download" aria-hidden="true"></i>Tambahkan Produk</span>
                  </button>
...
if(isset($_POST['submit'])){
	 ...
	 $produk_author = $_POST['produk_author'];
	...
	if($produk_judul=='' OR $produk_cat=='null' OR $produk_author=='' OR $produk_gambar=='' OR $produk_content==''){
		...
		mkdir($path);
		$path2 = "../../upload/attachment/$time";
		mkdir($path2);
		move_uploaded_file($produk_gambar_tmp,"../../upload/images/$time/$produk_gambar");
		move_uploaded_file($produk_attachment_tmp,"../../upload/attachment/$time/$produk_attachment");
		
		$insert_product = "insert into produk (produk_judul,produk_tipe,produk_date,category_id,produk_author,produk_keywords,produk_gambar,produk_attachment,produk_content,produk_harga,produk_pabrikan,produk_model,produk_tahun,produk_kapasitas,produk_boom,produk_jib,produk_published,time, jumlah_barang) 
		values 
		('$produk_judul','$produk_tipe','$produk_date','$produk_cat','$produk_author','$produk_keywords','$produk_gambar','$produk_attachment','$produk_content','$produk_harga','$produk_pabrikan','$produk_model','$produk_tahun','$produk_kapasitas','$produk_boom','$produk_jib','$produk_published','$time', '$jumlah_barang')";
