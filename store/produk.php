...
if(isset($_GET['id'])){
	...
	while ($row_products = mysql_fetch_array($run_product))
	{
	 ...
	 $produk_attachment = $row_products['produk_attachment'];
...
<div class="post-69 product type-product status-publish has-post-thumbnail product_cat-handheld-breakers shipping-taxable purchasable product-type-simple product-cat-handheld-breakers instock">
<div class="images">
<div class="p-gallery">
<div id="sync-preview" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
<div class="owl-wrapper-outer">
<div class="owl-wrapper" style="width: 1072px; left: 0px; display: block;">
<div class="owl-item" style="width: 350px;">
<div class="item" itemprop="image">
<a href="<?php echo ROOT_URL; ?>/upload/images/<?php echo $time; ?>/<?php echo $produk_gambar; ?>" itemprop="image" class="woocommerce-main-image zoom" title="product22" alt="">
<img width="350" height="427" src="<?php echo ROOT_URL; ?>/upload/images/<?php echo $time; ?>/<?php echo $produk_gambar; ?>" class="attachment-shop_single wp-post-image" alt="<?php echo $produk_judul; ?>">
</a>
</div>
</div>
...
<div class="p-thumb">
<div id="sync-thumb" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
...
<h1 itemprop="name" class="product_title entry-title"><?php echo $produk_judul; ?></h1>
<div class="p-rate-price">
<div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
<p class="price">
<span class="amount">Rp.<?php echo $produk_harga; ?></span>
</p>
</div>
</div>
<div class="product_meta">
<span class="sku_wrapper">SKU:
<span class="sku" itemprop="sku"><?php echo $produk_id; ?></span>.
</span>
<span class="posted_in">Pabrikan:
<?php echo $produk_pabrikan; ?>
</span>
<span class="posted_in">Model:
<?php echo $produk_model; ?>
</span>
<span class="posted_in">Tahun:
<?php echo $produk_tahun; ?>
</span>
<span class="posted_in">Kapasitas:
<?php echo $produk_kapasitas; ?>
</span>
<span class="posted_in">Boom:
<?php echo $produk_boom; ?>
</span>
<span class="posted_in">Jib:
<?php echo $produk_jib; ?>
</span>
<span class="posted_in">Jumlah Barang:
...
<?php
	if ($jumlah_barang == 0) {
?>
		<p>Maaf jumah barang yang tersedia adalah 0</p>
<?php
	} else {
?>
		<a href="<?php echo ROOT_URL; ?>/order/order.php?id=<?php echo $produk_id; ?>" type="button" class="wpcf7-form-control wpcf7-submit">Order</a>
<?php
	}
?>

</div>
<div class="k2t-tabs fill woocommerce-tabs">
<ul class="responsive-tabs tabs">
<li class="description_tab active">
<a href="product-detail.html#tab-description" target="_self">Description</a>
</li>
</ul>
<div class="responsive-tabs-content">
<div class="responsive-tabs-panel panel entry-content" id="tab-description">
<h2>Product Description</h2>
<p><?php echo $produk_content; ?></p>
</div>
<div class="panel entry-content responsive-tabs-panel" id="tab-additional_information">
...
<th>Attachment</th>
<td>
<p><a href="<?php echo ROOT_URL; ?>/upload/attachment/<?php echo $time; ?>/<?php echo $produk_attachment; ?>"><?php echo $produk_attachment; ?></p>
</td>
</tr>
</tbody>
</table>
