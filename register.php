...
if(isset($_SESSION['regsuccess'])){
   ...
   if($_SESSION['regsuccess']){
      echo "<h1 class='main-title' style='font-size:20px;'>Registrasi Berhasil!</h1>";
      echo "<p style='color:white;letter-spacing:1px;'>Terima Kasih <b>".$_SESSION['reguname']."</b>, informasi anda telah berhasil masuk ke dalam databasi kami, "
          ."sekarang anda bisa melakukan <a href=\"login.php\">log in</a>.</p>";
   }
   /* Registration failed */
   else{
...
{
?>
<h1 class="main-title" style="font-size:20px;">Registrasi </h1>
...
<div class="form-group">
  <label style="color:white;letter-spacing:1px;" class="col-md-4 control-label" for="nama_lengkap">Nama Lengkap</label>  
  <div class="col-md-4">
  <input id="nama_lengkap" name="nama_lengkap" type="text" placeholder="Nama Lengkap Anda" class="form-control input-md" required="" maxlength="50">
    <?php echo $form->error("nama_lengkap"); ?>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="user" name="user" type="text" placeholder="Username" class="form-control input-md" required="" maxlength="30">
...
<!-- Text input-->
<div class="form-group">
  <label style="color:white;letter-spacing:1px;" class="col-md-4 control-label" for="email">E-mail</label>  
  <div class="col-md-4">
  <input id="email" name="email" type="text" placeholder="email@anda.com" class="form-control input-md" required="" maxlength="50">
...
<!-- Text input-->
<div class="form-group">
  <label style="color:white;letter-spacing:1px;" class="col-md-4 control-label" for="phone_number">Phone Number</label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="pass" name="pass" type="password" placeholder="Password" class="form-control input-md" required="" maxlength="30">
    <?php echo $form->error("pass"); ?>
  </div>
</div>
<input type="checkbox" id="term">
  <font style="color:white;letter-spacing:1px;">I agree to the terms</font>
