...
<input type="hidden" name="user_name" value="<?php echo $session->username; ?>">
<input type="hidden" name="conversation_full_name" value="<?php echo $req_user_info['nama_lengkap']; ?>">
<input type="hidden" name="conversation_phone_number" value="<?php echo $req_user_info['phone_number']; ?>">
<input type="hidden" name="conversation_email" value="<?php echo $req_user_info['email']; ?>">
</div>
<div class="k2t-row">

<div class="col-6">
<p>Perihal<br> 
<select name="conversation_title" style="width: 300px">
...
<p>Pesan Anda<br><span class="wpcf7-form-control-wrap your-message"><textarea name="conversation_content" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false"></textarea></span> </p>
<p><input type="submit" name="submit" value="Send Message" class="wpcf7-form-control wpcf7-submit"><img class="ajax-loader" src="<?php echo ROOT_URL; ?>/images/ajax-loader.gif" alt="Sending ..." style="visibility: hidden;"></p>
...
if(isset($_POST['submit'])){
		...
		$conversation_full_name = $_POST['conversation_full_name'];
		$conversation_phone_number = $_POST['conversation_phone_number'];
		$conversation_email = $_POST['conversation_email'];
		$conversation_title = $_POST['conversation_title'];
		$conversation_content = $_POST['conversation_content'];
		$username = $_POST['user_name'];
		$conversation_date = date('d-m-Y');
		
		$insert_posts = "insert into conversation (conversation_full_name,conversation_phone_number,conversation_email,conversation_title,conversation_content,username,conversation_date) values ('$conversation_full_name','$conversation_phone_number','$conversation_email','$conversation_title','$conversation_content','$username','$conversation_date')";
