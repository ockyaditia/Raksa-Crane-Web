...
<input class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" type="text" name="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $req_user_info['nama_lengkap'];?>">
</span>
</p>
<p>
<span class="wpcf7-form-control-wrap your-email">
<input class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" type="text" name="phone_number" id="phone_number" placeholder="Phone Number" value="<?php echo $req_user_info['phone_number'];?>">
</span>
</p>
<p>
<span class="wpcf7-form-control-wrap your-email">
<input class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" type="text" name="alamat_lengkap" placeholder="Alamat Lengkap" value="<?php echo $req_user_info['alamat_lengkap'];?>">
</span>
</p>
</div>
<div class="col-6">
<br>
<p>
<input name="submit" type="submit" value="Simpan" class="wpcf7-form-control wpcf7-submit">
...
if(isset($_POST['submit'])){
	...
	if($nama_lengkap=='' OR $phone_number=='' OR $alamat_lengkap==''){
		...
		$update_product = "update users set nama_lengkap='$nama_lengkap',alamat_lengkap='$alamat_lengkap',phone_number='$phone_number' where username='$session->username'";
